...
save(results, file = paste0(local_path,"3.results/leucophee/leucophee_HIV_gps_fix.rdata"))
...
save(results, file = paste0(local_path,"3.results/leucophee/leucophee_ETE_gps_fix_without_col.rdata"))
rm(out_rsf, data_rsf, cov_rsf, results, data_gps_aug, data_gps, species, month_to_keep)
...
save(results, file = paste0(local_path,"3.results/leucophee/leucophee_ETE_gps_fix_with_col.rdata"))
...
save(results, file = paste0(local_path,"3.results/caugek/caugek_HIV_gps_fix.rdata"))
rm(out_rsf, data_rsf, cov_rsf, results, data_gps_aug, data_gps, species, month_to_keep)
...
save(results, file = paste0(local_path,"3.results/caugek/caugek_ETE_gps_fix_without_col.rdata"))
rm(out_rsf, data_rsf, cov_rsf, results, data_gps_aug, data_gps, species, month_to_keep)
...
save(results, file = paste0(local_path,"3.results/caugek/caugek_ETE_gps_fix_with_col.rdata"))
rm(out_rsf, data_rsf, cov_rsf, results, data_gps_aug, data_gps, species, month_to_keep, covariates)
...
save(results, file = paste0(local_path,"3.results/scopoli/scopoli_ETE_gps_fix_without_col.rdata"))
rm(out_rsf, data_rsf, cov_rsf, results, data_gps_aug, data_gps, species, month_to_keep)

# Migralion - seabirds space use :bird: :hatched_chick:
...
1. Run `4.reports/Seabirds_results.rmd` to summarize all the results from the different models
2. Run `4.reports/Vulnerability.rmd` to create vulnerability maps for each season
